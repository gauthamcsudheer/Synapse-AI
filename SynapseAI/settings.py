"""
Django settings for SynapseAI project.
...
SECRET_KEY = 'django-insecure-15$8=1b4@=hekpsj#2l-(1x0)i!asmig#m_8w4!wj!5ja0sdmv'
...
WSGI_APPLICATION = 'SynapseAI.wsgi.application'
